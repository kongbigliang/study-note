...
import com.kongbig.java8.bean.Status;
...
public class TestStreamApi4 {
    ...
    @Test
    public void test2() {
        Optional<Employee> optional1 = emps.stream().sorted((e1, e2) -> Double.compare(e1.getSalary(), e2.getSalary())).findFirst();
        System.out.println(optional1.get());

        System.out.println("------------------");

        // 用并行流来找
        Optional<Employee> optional2 = emps.parallelStream().filter((e) -> e.getStatus().equals(Status.FREE)).findAny();
